...
@borg.on(events.NewMessage(pattern=r"#SOL_irl", incoming=True, chats=-1001396985779))
async def _(event):
	if event.reply_to_msg_id:
		...
		await borg.send_message("@HyperNB", "https://t.me/xdaofftopicgroup/{}".format(message_id)) 
